...
from ...database.models import Req, ReqCollection, User as DBUser, Module, Tag
...
async def list_requirements(
    ...
    req_collection_id: Optional[int] = Query(None),
    # Sorting
    ...
    query = (
        select(Req)
        .join(ReqCollection)
        .where(ReqCollection.workspace_id == workspace_id)
    )
    ...
    if req_collection_id:
        query = query.where(Req.req_collection_id == req_collection_id)
    ...
    requirement_list = [
        RequirementResponse(
            ...
            req_collection_id=req.req_collection_id,
...
async def create_requirement(
    ...
    req_collection_query = select(ReqCollection).where(
        and_(
            ReqCollection.id == req_data.req_collection_id,
            ReqCollection.workspace_id == workspace_id
        )
    )
    ...
    new_req = Req(
        req_collection_id=req_data.req_collection_id,
    ...
    requirement_response = RequirementResponse(
        ...
        req_collection_id=new_req.req_collection_id,
...
async def get_requirement(
    ...
    requirement_response = RequirementResponse(
        ...
        req_collection_id=requirement.req_collection_id,
...
async def create_requirement_version(
    ...
    new_version = Req(
        ...
        req_collection_id=latest_version.req_collection_id,
    ...
    requirement_response = RequirementResponse(
        ...
        req_collection_id=new_version.req_collection_id,
