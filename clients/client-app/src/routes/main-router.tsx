...
import DevWorkspaceManager from "./dev-workspace-manager";
  ...
  return (
    <ApplicationShell>
      <Routes>
        ...
        <Route path="/dev/workspaces" element={<DevWorkspaceManager />} />
        ...
        <Route path="/workspace/:workspaceId/modules/:moduleId" element={<ModuleDetail />} />
        ...
        <Route path="/workspace/:workspaceId/agent" element={<AgentView />} />
